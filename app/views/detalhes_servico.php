            ...
            <div class="pb-5 pb-md-0">
                <div class="next-prev-btn">
                    <button class="prev-btn button">
                        <img src="http://localhost/kioficina/public/assets/img/SVG/prev.svg" alt="..."><span> prev</span>
                    </button>
                    <button class="next-btn button">
                        <span>next</span> <img src="http://localhost/kioficina/public/assets/img/SVG/next.svg" alt="..">
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="content">
                <div class="single-blog-list" data-aos="fade-up">
                  ...
                  <p class="single-blog-desp">
                    ...
                    <img src="http://localhost/kioficina/public/assets/img/services-single.jpg" data-aos="fade-up" class="img-fluid" alt="...">
