...
<head>
    ...
    <title><?php echo isset($titulo) ? $titulo : 'Serviços-detalhes - Ki Oficina' ?></title>
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/reset.css">

    <!-- SLICK -->
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/slick.css">
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/slick-theme.css">

    <!-- LITY -->
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/lity.css">
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/estilo.css">

    <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE --> <!-- ESTILO DO TEMPLATE -->

    <link rel="icon" href="http://localhost/kioficina/public/assets/img/SVG/favicon.svg" />
    <!-- Site Title -->
    <title>Car Repair & Auto Services</title>

    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/plugins/lightgallery.min.css" />
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/plugins/swiper.min.css" />
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/plugins/aos.css" />
    <link rel="stylesheet" href="http://localhost/kioficina/public/assets/style/plugins/bootstrap.min.css" />
...
<body>
    ...
    <div class="espacoContato"></div>

    <section class="detalhespag">
        <article class="site">
            <div class="titulo">
                <div>
            ...
            <div class="detalhesinf">

                <div class="infs">
                    <div class="single-list" data-aos="fade-up">
                        <h4>AutoCare Solutions - Tire Services</h4>
                        <p>
                        ...
                        <img src="http://localhost/kioficina/public/assets/img/services-single.jpg" class="img-fluid" alt="...">
                        <div class="espaco"></div>
                    </div>

                    
                    <div class="single-list" data-aos="fade-up">
                        <h4>1. Tire Rotation:</h4>
                        <p>Regular tire rotation is essential for even tread wear and
                            longevity.
                    ...
                    <div class="single-list" data-aos="fade-up">
                        <h4>2. Tire Balancing:</h4>
                        <p>Imbalanced tires can lead to uneven wear, vibrations, and handling
                    ...
                    <div class="single-list" data-aos="fade-up">
                        ...
                        <div class="sessao_fotos_inf">
                            <img src="http://localhost/kioficina/public/assets/img/services-single-2.jpg" class="img-fluid" alt="...">
                            <img src="http://localhost/kioficina/public/assets/img/services-single-3.jpg" class="img-fluid d-none d-lg-block" alt="...">
                        </div>
                        <div class="espaco"></div>
                    </div>
