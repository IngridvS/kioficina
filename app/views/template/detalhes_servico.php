...
<?php require_once('template/topo.php');?>
    ...
    <div class="ak-height-125 ak-height-lg-80"></div>
    <div class="container">
        <h4 class="faq-images-title" data-aos="fade-left">Frequently Asked Questions</h4>
        <div class="faq-images">
            <div class="faq" data-aos="fade-up">
                <div class="ak-accordion">
                    <div class="ak-accordion-item" data-aos="fade-up">
                        <div class="ak-accordion-title active">
                            <h6>What services do you offer at your auto repair shop?</h6>
                        </div>
                        <div class="ak-accordion-tab">
                            We provide a comprehensive range of auto services, including but not limited to routine
                            maintenance,
                            brake repairs, tire services, engine diagnostics, oil changes, suspension repairs, and
                            more.
                            Our
                            experienced technicians are equipped to handle various automotive issues.
                        </div>
                    </div>
                    <div class="ak-accordion-item" data-aos="fade-up">
                        <div class="ak-accordion-title">
                            <h6>How often should I get my car serviced?</h6>
                        </div>
                        <div class="ak-accordion-tab">
                            We provide a comprehensive range of auto services, including but not limited to routine
                            maintenance,
                    ...
                    <div class="ak-accordion-item" data-aos="fade-up">
                        <div class="ak-accordion-title">
                            <h6>How do I know if my brakes need to be replaced?</h6>
                        </div>
                        <div class="ak-accordion-tab">
                            We provide a comprehensive range of auto services, including but not limited to routine
                            maintenance,
                    ...
                    <div class="ak-accordion-item" data-aos="fade-up">
                        <div class="ak-accordion-title">
                            <h6>What steps can I take to maintain car between services?</h6>
                        </div>
                        <div class="ak-accordion-tab">
                            We provide a comprehensive range of auto services, including but not limited to routine
                            maintenance,
                    ...
                    <div class="ak-accordion-item" data-aos="fade-up">
                        <div class="ak-accordion-title">
                            <h6>Do you provide warranty on your auto repairs?</h6>
                        </div>
                        <div class="ak-accordion-tab">
                            We provide a comprehensive range of auto services, including but not limited to routine
                            maintenance,
            ...
            <div class="images" data-aos="fade-up" data-aos-delay="150">
                <img src="assets/img/accordion-side-img.jpg" class="img-bg-faq" alt="...">
                <div class="images-info">
                    ...
                    <div class="ak-location">
                        <a href="#" class=" d-flex gap-2 text-hover-animaiton">
                            <span class="me-1">
                    ...
                    <div class="ak-date-time">
                        <a href="#" class="d-flex gap-2 date text-hover-animaiton">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                    fill="none">
                                    <g clip-path="url(#clip0_365_24351)">
                                        <path
                ...
                <div class="footer-address" data-aos="fade-up" data-aos-delay="150" data-aos-duration="500">
                    ...
                    <p class="date">
                        <span class="me-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                fill="none">
                                <g clip-path="url(#clip0_365_24352)">
                                    <path
                                        d="M5.33535 2.66895C5.42375 2.66895 5.50854 2.63383 5.57105 2.57131C5.63356 2.5088 5.66868 2.42402 5.66868 2.33561V1.00228C5.66868 0.913873 5.63356 0.829089 5.57105 0.766576C5.50854 0.704064 5.42375 0.668945 5.33535 0.668945C5.24694 0.668945 5.16216 0.704064 5.09965 0.766576C5.03713 0.829089 5.00201 0.913873 5.00201 1.00228V2.33561C5.00201 2.42402 5.03713 2.5088 5.09965 2.57131C5.16216 2.63383 5.24694 2.66895 5.33535 2.66895Z"
                                        fill="white" />
                                    <path
