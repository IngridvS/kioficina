            ...
            <?php foreach ($depoimentos as $depoimento): ?>
                ...
                <div class="depos">
                    <div class="depos_inf">
                        ...
                        <div class="depos_t">
                            <div>
                                <h5><?php echo htmlspecialchars($depoimento['nome_cliente'], ENT_QUOTES, 'UTF-8'); ?></h5>
                                <p><?php echo htmlspecialchars($depoimento['cidade_cliente'], ENT_QUOTES, 'UTF-8'); ?></p>
                            </div>
                            <div class="icon">
                        ...
                        <div class="depor-p">
                            <h4><?php echo htmlspecialchars($depoimento['descricao_depoimento'], ENT_QUOTES, 'UTF-8'); ?></h4>
                        </div>
                    </div>
